...
|------|------|------|-----------|----------|--------|
| **Looi** | Looi Robotics | 充电头机器人 (手机作屏) | 千问实时多模态（qwen3.5-omni-plus-realtime + qwen-audio-3.0-realtime-flash） | 语音对话 + 肢体动作 + 手机屏表情 | $199 (众筹) |
...
- **亮点**：硬件配置极简，软件定义体验
- **模型**：已迁移至千问实时多模态链路，同时使用 qwen3.5-omni-plus-realtime 与 qwen-audio-3.0-realtime-flash
