...
精选跨品类的 8 个"Wow feature"——都是**能收费、有付费锚点**的功能，看完就懂 AI 硬件能做出什么样的产品。

| 品类 | 亮点功能 | 一句话描述 | 付费锚点 |
|---|---|---|---|
| 📷 IPC | 自然语言找回放 | "找昨晚小孩跳沙发那段"→ 5 秒定位 | AI 订阅 5~9.9 元/月 |
...
| 🪴 桌宠 | 情绪 → 动作联动 | AI 识别语气 → 触发实体机器人表情 / 摇头 / 摆手 | 硬件 + 情感包 |
| 👓 眼镜 | 一看即懂 | 对着菜单/招牌看一眼 → 耳机播报翻译 + 推荐 | 硬件溢价 + 翻译功能包（探索期） |
| 👓 眼镜 | 给 AI 打电话 | 按住镜腿即问即答，AI 实时看你所见、边走边聊 | 旗舰档硬件溢价 |
| 🎙️ 录音卡 | 一键会议纪要 | 会后 3 分钟出结构化纪要 + 待办 + 分角色发言 | SaaS 订阅 |
| 🎧 AI 耳机 | 实时同传 | 开会同声传译，不用看屏幕，边听边说 | AI 功能包 |

> 想看完整功能清单和商业化打法？进入对应品类的 [`solutions/by-category/`](./solutions/by-category/) 目录。

### 🧪 脑洞实验室（待验证）

以下是**还没大规模跑通、但很有想象力**的方向，欢迎在 Issue / Discussion 里一起探讨：

- **IPC × 宠物社交**：AI 摄像头自动为宠物生成朋友圈动态（"今日金毛偷吃了三口粮"）
- **玩具 × 亲子异地陪伴**：外地爸爸的声音 + AI 补齐互动，让孩子每晚都能"和爸爸聊天"（⚖️ 注意：「AI 模拟亲属与未成年人持续互动」触及《人工智能拟人化互动服务管理暂行办法》第十四条虚拟亲属禁令，探索前先做合规评估，见 [faq.md](./faq.md) Q22.1）
- **桌宠 × 情绪陪伴日记**：桌宠记录主人一周的情绪走势，输出一份"情绪周报"
- **眼镜 × 老年人辅助**：识别药盒 → 语音提醒吃药量，识别路人 → 提醒是不是熟人
- **具身 × 家务教学**：让机械臂看家长示范一次 → 自动学会叠一种衣服
